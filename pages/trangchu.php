...
<div class="box-cat">
	<div class="cat">
        ...
        <div class="child-cat">
			<?php
		$loaitin = DanhSachLoaiTin_Theo_TheLoai($idLT);
	while($row_loaitin = mysqli_fetch_array($loaitin)){
        ...
        <div class="cat-content">
        	<div class="col1">
            	...
            	<div class="news">
					<?php
	$tintrai = TinMoi_BenTrai($idLT);
	$row_tintrai = mysqli_fetch_array($tintrai);
					?>
                    <h3 class="title" ><a href="#"><?php echo $row_tintrai['TieuDe']?> </a></h3>
            ...
            <div class="col2">
				<?php
					$tinphai = TinMoi_BenPhai($idLT);
	while($row_tinphai = mysqli_fetch_array($tinphai)){
				?>
             <p class="tlq"><a href="./index.php?p=chitiettin&idLT=<?php echo $row_tinphai['idLT']?>"> <?php echo $row_tinphai['TieuDe']?></a>
                </a></p>
		<?php
}
		?>
